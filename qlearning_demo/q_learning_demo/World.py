...
specials = [(6, 6, "red", -1), (7, 6, "red", -1), (8, 6, "red", -1), (5, 4, "green", 1), (9, 4, "green", 1)]
cell_scores = {}
...
def random_position(walls, specials, max_x, max_y):
    randx = np.random.randint(0, max_x)
    randy = np.random.randint(0, max_y)
    position = (randx, randy)

    if position in walls :
        return random_position(walls, specials, max_x, max_y)
...
def restart_game():
    ...
    player = random_position(walls, specials, 15, 11)
    score = 1
    restart = False
